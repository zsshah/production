...
## Grid Operations Center (Scott)
   ...
   * [OSG CPU hours](https://gracc.opensciencegrid.org/dashboard/db/vo-summary?panelId=22&fullscreen&orgId=1&from=now-1y&to=now&var-interval=$__auto_interval&var-vo=All&var-type=Batch}
